...
class DocumentRequestsController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            // The period a report should cover, which is history rather than a
            // deadline — so it is bounded the other way, and `period_to` may
            // not precede `period_from`.
            'period_from' => 'nullable|date|before_or_equal:today',
            'period_to' => 'nullable|date|after_or_equal:period_from|before_or_equal:today',
        ]);
