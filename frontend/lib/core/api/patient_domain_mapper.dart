...
class PatientDomainMapper {
  ...
  static MedicalDocument documentFromApi(Map<String, dynamic> json) {
    return MedicalDocument(
      ...
      clinicalReportId: json['clinical_report_id'] as String?,
  ...
  static DocumentRequest documentRequestFromApi(Map<String, dynamic> json) {
    return DocumentRequest(
      ...
      periodFrom: parseDate(json['period_from'] as String?),
      periodTo: parseDate(json['period_to'] as String?),
  ...
  static Map<String, dynamic> documentRequestToApi({
    ...
    // The period a report should cover. Sent only when both ends are known —
    // half a range is not a range, and the server would reject it.
