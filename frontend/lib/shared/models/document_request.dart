...
class DocumentRequest {
  ...
  /// The stretch of record a requested report should cover.
  ///
  /// A different question from [neededBy], which is a deadline. A report is
  /// *of* something, and the thing it is of is a period — a patient asking for
  /// a vitals report for their August consultation had no way to say August,
  /// so the clinician guessed or had to message back to ask.
  final DateTime? periodFrom;
  final DateTime? periodTo;

  /// Whether this request names a period at all.
